                                        ...
                                        <div class="product-main no-arrow">
                                            <div>
                                                <div class="slider-image">
                                                    <img src="furniz/assets/images/fashion/product/23.jpg" id="img-1"
                                                        data-zoom-image="furniz/assets/images/fashion/product/23.jpg"
                                                        class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="furniz/assets/images/fashion/product/24.jpg"
                                                        data-zoom-image="furniz/assets/images/fashion/product/24.jpg"
                                                        class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="furniz/assets/images/fashion/product/25.jpg"
                                                        data-zoom-image="furniz/assets/images/fashion/product/25.jpg"
                                                        class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="furniz/assets/images/fashion/product/26.jpg"
                                                        data-zoom-image="furniz/assets/images/fashion/product/26.jpg"
                                                        class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="furniz/assets/images/fashion/product/23.jpg"
                                                        data-zoom-image="furniz/assets/images/fashion/product/23.jpg"
                                                        class="
                                    ...
                                    <ul>
                                        <li>
                                            <a href="javascript:void(0)">
                                                <img src="furniz/assets/images/product/payment/1.svg"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)">
                                                <img src="furniz/assets/images/product/payment/2.svg"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)">
                                                <img src="furniz/assets/images/product/payment/3.svg"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)">
                                                <img src="furniz/assets/images/product/payment/4.svg"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)">
                                                <img src="furniz/assets/images/product/payment/5.svg"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                    </ul>
                        ...
                        <div class="vendor-box">
                            <div class="vendor-contain">
                                <div class="vendor-image">
                                    <img src="furniz/assets/images/product/vendor.png" class="blur-up lazyload"
                                        alt="">
                                </div>
                                ...
                                <ul>
                                        ...
                                        <div class="product-box product-box-bg wow fadeInUp">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="furniz/assets/images/fashion/product/27.png"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                            </div>
                                    ...
                                    <li>
                                        <div class="product-box product-box-bg wow fadeInUp" data-wow-delay="0.1s">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="furniz/assets/images/fashion/product/28.png"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                            </div>
                                            <div class="product-detail">
                                    ...
                                    <li>
                                        <div class="product-box product-box-bg wow fadeInUp">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="furniz/assets/images/fashion/product/29.png"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                            </div>
                                            <div class="product-detail">
                            ...
                            <div class="tab-pane fade show active" id="description" role="tabpanel">
                                <div class="product-description">
                                    ...
                                    <div class="banner-contain nav-desh">
                                        <img src="furniz/assets/images/vegetable/banner/14.jpg"
                                                            ...
                                                            <div>
                                                                <div class="people-image people-text">
                                                                    <img alt="user" class="img-fluid "
                                                                        src="furniz/assets/images/review/1.jpg">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <li>
                                                        <div class="people-box">
                                                            <div>
                                                                <div class="people-image people-text">
                                                                    <img alt="user" class="img-fluid "
                                                                        src="furniz/assets/images/review/2.jpg">
                                                                </div>
                                                            </div>
                                                            <div class="people-comment">
                                                                <div class="people-name"><a href="javascript:void(0)"
                                                    ...
                                                    <li>
                                                        <div class="people-box">
                                                            <div>
                                                                <div class="people-image people-text">
                                                                    <img alt="user" class="img-fluid "
                                                                        src="furniz/assets/images/review/3.jpg">
                                                                </div>
                                                            </div>
                                                            <div class="people-comment">
                                                                <div class="people-name"><a href="javascript:void(0)"
                                                    ...
                                                    <li>
                                                        <div class="people-box">
                                                            <div>
                                                                <div class="people-image people-text">
                                                                    <img alt="user" class="img-fluid "
                                                                        src="furniz/assets/images/review/4.jpg">
                                                                </div>
                                                            </div>
                                                            <div class="people-comment">
                                                                <div class="people-name"><a href="javascript:void(0)"
                                                    ...
                                                    <li>
                                                        <div class="people-box">
                                                            <div>
                                                                <div class="people-image people-text">
                                                                    <img alt="user" class="img-fluid "
                                                                        src="furniz/assets/images/review/5.jpg">
                                                                </div>
                                                            </div>
                                                            <div class="people-comment">
                                                                <div class="people-name"><a href="javascript:void(0)"
                                ...
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left.htm">
                                            <img src="furniz/assets/images/cake/product/11.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.05s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="furniz/assets/images/cake/product/2.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="furniz/assets/images/cake/product/3.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.15s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="furniz/assets/images/cake/product/4.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.2s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="furniz/assets/images/cake/product/5.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.25s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="furniz/assets/images/cake/product/6.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="furniz/assets/images/cake/product/7.png" class="img-fluid"
                                                alt="">
                                        </a>

                    ...
                    <div class="slider-7_1 no-space shop-box no-arrow">
                            ...
                            <div class="shop-category-box">
                                <a href="shop-left-sidebar.html">
                                    <div class="shop-category-image">
                                        <img src="furniz/assets/svg/1/vegetable.svg" class="blur-up lazyload" alt="">
                                    </div>
                        ...
                        <div>
                            <div class="shop-category-box">
                                <a href="shop-left-sidebar.html">
                                    <div class="shop-category-image">
                                        <img src="furniz/assets/svg/1/biscuit.svg" class="blur-up lazyload" alt="">
                                    </div>
                                    <div class="category-box-name">
                        ...
                        <div>
                            <div class="shop-category-box">
                                <a href="shop-left-sidebar.html">
                                    <div class="shop-category-image">
                                        <img src="furniz/assets/svg/1/grocery.svg" class="blur-up lazyload" alt="">
                                    </div>
                                    <div class="category-box-name">
                                ...
                                <ul>
                                    <li class="three-grid">
                                        <a href="javascript:void(0)">
                                            <img src="furniz/assets/svg/grid-3.svg" class="blur-up lazyload"
                                                alt="">
                                        </a>
                                    </li>
                                    <li class="grid-btn d-xxl-inline-block d-none active">
                                        <a href="javascript:void(0)">
                                            <img src="furniz/assets/svg/grid-4.svg"
                                                class="blur-up lazyload d-lg-inline-block d-none" alt="">
                                            <img src="furniz/assets/svg/grid.svg"
                                    ...
                                    <li class="list-btn">
                                        <a href="javascript:void(0)">
                                            <img src="furniz/assets/svg/list.svg" class="blur-up lazyload"
                                                alt="">
                                        </a>
                                    </li>
                                </ul>

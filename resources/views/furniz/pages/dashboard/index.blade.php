                    ...
                    <div class="dashboard-left-sidebar">
                        ...
                        <div class="profile-box">
                            <div class="cover-image">
                                <img src="furniz/assets/images/inner-page/cover-img.jpg" class="img-fluid blur-up lazyload"
                                    alt="">
                            </div>
                                        ...
                                        <div class="row g-sm-4 g-3">
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="total-contain">
                                                    <img src="furniz/assets/images/svg/order.svg"
                                                        class="img-1 blur-up lazyload" alt="">
                                                    <img src="furniz/assets/images/svg/order.svg" class="blur-up lazyload"
                                                        alt="">
                                            ...
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="total-contain">
                                                    <img src="furniz/assets/images/svg/pending.svg"
                                                        class="img-1 blur-up lazyload" alt="">
                                                    <img src="furniz/assets/images/svg/pending.svg"
                                            ...
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="total-contain">
                                                    <img src="furniz/assets/images/svg/wishlist.svg"
                                                        class="img-1 blur-up lazyload" alt="">
                                                    <img src="furniz/assets/images/svg/wishlist.svg"
                                                        class="blur-up lazyload" alt="">
                                                    <div class="total-detail">
                                        ...
                                        <div class="col-xxl-3 col-lg-6 col-md-4 col-sm-6">
                                            <div class="product-box-3 theme-bg-white h-100">
                                                <div class="product-header">
                                                    <div class="product-image">
                                                        <a href="product-left-thumbnail.html">
                                                            <img src="furniz/assets/images/cake/product/7.png"
                                                                class="img-fluid blur-up lazyload" alt="">
                                                        </a>
                                ...
                                <div class="dashboard-order">
                                    ...
                                    <div class="order-contain">
                                        ...
                                        <div class="order-box dashboard-bg-box">
                                            ...
                                            <div class="product-order-detail">
                                                <a href="product-left-thumbnail.html" class="order-image">
                                                    <img src="furniz/assets/images/vegetable/product/2.png" alt=""
                                        ...
                                        <div class="order-box dashboard-bg-box">
                                            ...
                                            <div class="product-order-detail">
                                                <a href="product-left-thumbnail.html" class="order-image">
                                                    <img src="furniz/assets/images/vegetable/product/3.png" alt=""
                                                        class="blur-up lazyload">
                                                </a>
                                            ...
                                            <div class="payment-card-detail">
                                                <div class="card-details">
                                                    ...
                                                    <div class="name-detail">
                                                        ...
                                                        <div class="card-img">
                                                            <img src="furniz/assets/images/payment-icon/1.jpg"
                                            ...
                                            <div class="payment-card-detail">
                                                <div class="card-details card-visa">
                                                    ...
                                                    <div class="name-detail">
                                                        ...
                                                        <div class="card-img">
                                                            <img src="furniz/assets/images/payment-icon/2.jpg"
                                                                class="img-fluid blur-up lazyloaded" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="payment-card-detail">
                                                <div class="card-details debit-card">
                                                    ...
                                                    <div class="name-detail">
                                                        ...
                                                        <div class="card-img">
                                                            <img src="furniz/assets/images/payment-icon/3.jpg"
                                                                class="img-fluid blur-up lazyloaded" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="dashboard-profile">
                                    ...
                                    <div class="profile-about dashboard-bg-box">
                                        <div class="row">
                                            ...
                                            <div class="col-xxl-5">
                                                <div class="profile-image">
                                                    <img src="furniz/assets/images/inner-page/dashboard-profile.png"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>1</td>
                                                                    <td>
                                                                        <img src="furniz/assets/images/theme-icon/1.png"
                                                                            class="img-fluid" alt="">
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>2</td>
                                                                    <td>
                                                                        <img src="furniz/assets/images/theme-icon/2.png"
                                                                            class="img-fluid" alt="">
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>3</td>
                                                                    <td>
                                                                        <img src="furniz/assets/images/theme-icon/3.png"
                                                                            class="img-fluid" alt="">
                                                                    </td>
